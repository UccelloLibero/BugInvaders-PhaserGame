...
function create() {
  ...
  // for loop to create our rows of enemies
  ...
  this.physics.add.collider(pellets, gameState.player, () => {
    ...
    this.add.text(200, 200, 'Game Over.\nPlay again?', {fontSize: '15px', fill: '#FFF'});
  });
  ...
  this.physics.add.collider(gameState.enemies, gameState.player, () => {
    ...
    gameState.enemyVelocity = 1;
    this.physics.pause();
    this.add.text(200, 200, 'Game Over', { fontSize: '15px', fill: '#FFF'});
  });
}
